...
local hl_groups = {
  ...
  IncSearch                        = { fg = c.neutral.s900, bg = c.green.s300               },
  Search                           = { fg = c.neutral.s900, bg = c.yellow.s300              },
  CurSearch                        = { fg = c.neutral.s900, bg = c.green.s300               },
  ...
  StatusLine                       = { fg = c.neutral.s100, bg = c.neutral.s900             },
  StatusLineNC                     = { fg = c.neutral.s600, bg = c.neutral.s900             },
  TabLine                          = { fg = c.neutral.s600, bg = c.neutral.s950             },
  TabLineFill                      = { bg = c.neutral.s950                                  },
  ...
  DiagnosticFloatingError          = { fg = c.red.s300                                      },
  DiagnosticFloatingWarn           = { fg = c.yellow.s300                                   },
  DiagnosticFloatingInfo           = { fg = c.blue.s300                                     },
  DiagnosticFloatingHint           = { fg = c.cyan.s300                                     },
  DiagnosticFloatingOk             = { fg = c.green.s300                                    },
  ...
  -- mini.statusline
  MiniStatuslineModeNormal         = { fg = c.neutral.s900, bg = c.blue.s300,    bold=true  },
  MiniStatuslineModeInsert         = { fg = c.neutral.s900, bg = c.green.s300,   bold=true  },
  MiniStatuslineModeVisual         = { fg = c.neutral.s900, bg = c.magenta.s300, bold=true  },
  MiniStatuslineModeCommand        = { fg = c.neutral.s900, bg = c.cyan.s300,    bold=true  },
  MiniStatuslineModeDelete         = { fg = c.neutral.s900, bg = c.red.s300,     bold=true  },
  MiniStatuslineModeOther          = { fg = c.neutral.s900, bg = c.yellow.s300,  bold=true  },
  MiniStatuslineDevinfo            = { fg = c.neutral.s50,  bg = c.neutral.s700             },
  MiniStatuslineFileinfo           = { link = 'MiniStatuslineDevinfo'                       },
  MiniStatuslineFilename           = { fg = c.neutral.s300, bg = c.neutral.s900             },
